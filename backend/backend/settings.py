...
SECRET_KEY = 'django-insecure-y%jsdl3uuu-o8v(@_8mwidrp^2wg#eh9hf=7xnu(79g&#jlmjr'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'postgres',                  
        'HOST': 'db_dev', 
        # 'HOST': 'localhost',                # Host bazy danych (nazwa kontenera)
        'PORT': '5432', 
    }
}
...
CORS_ALLOW_CREDENTIALS = True  # Ustaw na True, jeśli chcesz przekazywać uwierzytelnienie
